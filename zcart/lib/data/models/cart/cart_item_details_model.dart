...
CartItemDetailsModel cartItemDetailsModelFromJson(String str) =>
    CartItemDetailsModel.fromJson(json.decode(str));

String cartItemDetailsModelToJson(CartItemDetailsModel data) =>
