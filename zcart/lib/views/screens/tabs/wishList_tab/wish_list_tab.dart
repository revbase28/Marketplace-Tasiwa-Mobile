                ...
                : ProviderListener<ScrollState>(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final wishExist =
                              wishListState.wishList.length > index &&
                                  wishListState.wishList[index] != null;
                          debugPrint("$index wish is not : ${wishExist}");
                          return !wishExist
                              ? const SizedBox()
                              : GestureDetector(
                                  onTap: () {
                                    context.nextPage(ProductDetailsScreen(
                                        productSlug: wishListState
                                            .wishList[index].slug!));
                                  },
                                  child: Container(
