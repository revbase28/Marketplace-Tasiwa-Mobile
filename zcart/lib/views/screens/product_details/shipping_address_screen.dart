                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      value: selectedCountry ??
                          widget.productModel.countries!.values.elementAt(widget
                              .productModel.countries!.keys
                              .toList()
                              .indexOf(widget.productModel.shippingCountryId
                                  .toString())),
                      ...
                      onChanged: (String? value) {
                        ...
                        context
                            ...
                            .fetchShippingOptions(
                                ...
                                null);
                        widget.productModel.shippingCountryId = int.parse(widget
                            .productModel.countries!.keys
                            .elementAt(widget.productModel.countries!.values
                                .toList()
                                .indexOf(selectedCountry.toString())));
                        context
